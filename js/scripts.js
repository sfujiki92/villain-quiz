//Business Logic
var add = function(color, place, style, music, food, work, sport) {
  return color + place + style + music + food + work + sport;
};
...
$(document).ready(function(){
  $("#quiz").submit(function(event){
    ...
    var result = add(color, place, style, music, food, work, sport, result);
    ...
    if (result <= 4) {
      ...
      villainName = "the RowdyRuff Boys!";
      ...
      villainName = "the Gang Green Gang!";
